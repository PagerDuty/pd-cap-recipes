...
Capistrano::Configuration.instance(:must_exist).load do |config|
  ...
  def safe_current_revision
    begin
      ...
      logger.info "*" * 80
      logger.info "An exception has occured while fetching the current revision. This is to be expected if this is your first deploy to this machine. Othewise, something is broken :("
